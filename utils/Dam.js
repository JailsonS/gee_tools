...
var adjCollection = function(collection, region, windowSize, polynomialOrder, targetBands) {
    var regCollection = twLinearInterpolateFit.getCollectionFitted(collection.select(targetBands), daysInterval, 30)
        .select(targetBands)
    ...
    var linearCollection = twLinearFit.getCollectionFitted(collection, 3, targetBands[0], 'month')
